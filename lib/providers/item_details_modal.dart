...
import '../models/restaurant.dart'; // Ensure MenuItem is defined here.
...
Future<void> showItemDetailsModal({
  ...
  showModalBottomSheet(
    ...
    builder: (context) {
      // Define available customizations.
      final List<String> availableCustomizations = ['chicken', 'shrimp', 'cheese', 'broccoli'];
      // Initially, no customization is selected.
                      ...
                      children: [
                        ...
                        Column(
                          children: availableCustomizations.map((option) {
                            bool isSelected = selectedCustomizations.contains(option);
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            // Update the item description if any customizations were selected.
                            ...
                            // Call the server to add the item and retrieve a document id.
                            final documentId = await sendCartItemToServer(
                              userId: storedUserId!,
                              restaurantId: 'bbm', // Replace with your actual restaurant id.
                              itemId: item.id,
                              quantity: 1,
                            ...
                            // Add the item to the cart with the updated description.
